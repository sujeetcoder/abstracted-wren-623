  ...
  return (
    <Box textAlign={"center"} fontWeight="semibold">
      ...
      <Box m="auto" w={["95%", "85%", "60%", "40%", "35%"]}>
        ...
        <Box>
          One Apple ID is all you need to access all Apple services. You already
          have an Apple ID?{" "}
          <Text
            as="span"
        ...
        <Flex gap="15px">
          ...
          <Box>
            ...
            <Text fontWeight={"normal"}>
              Receive Apple emails and communications including announcements,
              marketing, recommendations and updates about Apple products,
      ...
      >
        <Box w="35px" h="30px" m="auto">
          <Image
            src={
              "https://appleid.cdn-apple.com/static/bin/cb230738313/dist/assets/privacy-icon@2x.png"
            }
            w="100%"
            h="100%"
          />
